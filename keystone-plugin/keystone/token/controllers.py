...
class Auth(controller.V2Controller):
    ...
    def _authenticate_local(self, context, auth):
        ...
        # NOTE(adriant): This is a quick hack to stop users with totp
        # from being able to auth with the v2 api. This forces them
        # to use the v3 api which supports totp.
